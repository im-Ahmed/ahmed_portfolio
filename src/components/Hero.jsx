      ...
      <div className="max-w-[1000px] mx-auto px-8 sm:px-10 flex flex-col justify-center h-full">
        ...
        <div className="flex gap-4">
          <Link to="work" smooth={true} duration={500}>
            <button className="text-white group px-6 py-3 my-2 border-2 flex  items-center hover:bg-pink-700 hover:border-pink-700">
              View Work
              <HiArrowNarrowRight className="ml-3 group-hover:rotate-90 duration-150" />
            </button>
          </Link>
          <button className="text-white px-6 py-3 my-2 border-2 hover:bg-pink-700 hover:border-pink-700 xs:hidden">
